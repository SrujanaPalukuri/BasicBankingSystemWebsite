		 ...
		 function random_function()
            {
				...
				if(a==="Aman"){
				 var arr=["Himanshu","Paalak","Vijay","Varun","Shaheer","Barun","Karan","Arjun","Srujana"];
				 }
				 else if(a==="Himanshu"){
					var arr=["Aman","Paalak","Vijay","Varun","Shaheer","Barun","Karan","Arjun","Srujana"];
				}
				else if(a==="Paalak"){
					var arr=["Himanshu","Aman","Vijay","Varun","Shaheer","Barun","Karan","Arjun","Srujana"];
				}
				else if(a==="Vijay"){
					var arr=["Himanshu","Paalak","Aman","Varun","Shaheer","Barun","Karan","Arjun","Srujana"];
				 }
				 else if(a==="Varun"){
					var arr=["Himanshu","Paalak","Vijay","Aman","Shaheer","Barun","Karan","Arjun","Srujana"];
				 }
				 else if(a==="Shaheer"){
					var arr=["Himanshu","Paalak","Vijay","Varun","Aman","Barun","Karan","Arjun","Srujana"];
				 }
				 else if(a==="Barun"){
					var arr=["Himanshu","Paalak","Vijay","Varun","Shaheer","Aman","Karan","Arjun","Srujana"];
				 }
				 else if(a==="Karan"){
					var arr=["Himanshu","Paalak","Vijay","Varun","Shaheer","Barun","Aman","Arjun","Srujana"];
				 }
				 else if(a==="Arjun"){
					var arr=["Himanshu","Paalak","Vijay","Varun","Shaheer","Barun","Karan","Aman","Srujana"];
				 }
				 else if(a==="Srujana"){
